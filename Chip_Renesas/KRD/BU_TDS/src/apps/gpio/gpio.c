...
void gpio_xaSucPowerOnAuto()
{
    ...
    case 0:
        ...
        break;
    case 1:
    	//Kiem tra xem co nuoc hay khong
        if ((uint32_t)(g_sysTime - timeAuto) > 5000)
        {
            ...
            {
                getWater_setCurrent(1500);
            }
        }
        //Cho chay trong 2p sau do tat
        ...
        break;
    case 2:
    	//Tat trong 1p, sau do bat lai va dao chieu
    	if ((uint32_t)(g_sysTime - timeAuto) > 60000)
    	{
    		TURN_ON_VDT_2;
			TURN_ON_VDT_4;
			TURN_ON_VDT_5;
