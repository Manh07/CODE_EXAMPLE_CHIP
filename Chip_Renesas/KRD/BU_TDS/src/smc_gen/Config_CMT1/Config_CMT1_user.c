...
volatile uint16_t s_1000msCnt = 0;
uint32_t g_timeSpeed = TEST_SPEED;
volatile uint32_t g_sysTimeS = 0;
extern volatile bool g_beforemain;
volatile uint16_t cnt_20Ms = 0;
/* End user code. Do not edit comment generated here */
