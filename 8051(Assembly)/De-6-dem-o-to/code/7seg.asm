...
;------------------------------------------------------------
START:
    MOV R1, #0AH        ; Gan R1 = 10 (0AH), gia tri ban dau cua bien dem
...
;------------------------------------------------------------
; CHECK_BUTTON - Kiem tra cam bien IR (ket noi o P3.1 va P3.2)
;------------------------------------------------------------
CHECK_BUTTON:
    ; Kiem tra cam bien IR 1 (P3.1)
    JB P3.1, CHECK_IR2  ; Neu P3.1 = 1 (khong co vat can) thi kiem tra IR2
    ACALL DELAY_20MS    ; Delay ngan chong doi tin hieu
    JB P3.1, CHECK_IR2  ; Kiem tra lai, neu P3.1 van = 1 thi kiem tra IR2
...
WAIT_RELEASE_IR1:
    JNB P3.1, WAIT_RELEASE_IR1 ; Doi den khi cam bien khong bi che (P3.1 = 1)

CHECK_IR2:
    ; Kiem tra cam bien IR 2 (P3.2)
    JB P3.2, SKIP_BTN       ; Neu P3.2 = 1 (khong co vat can) thi bo qua
    ACALL DELAY_20MS        ; Delay ngan chong doi tin hieu
    JB P3.2, SKIP_BTN       ; Kiem tra lai, neu P3.2 van = 1 thi bo qua

    DEC R1                  ; Giam bien dem di 1
    CJNE R1, #00H, SKIP_BTN ; Neu R1 != 0 thi bo qua
    MOV R1, #59             ; Neu R1 = 0 thi reset ve 59

WAIT_RELEASE_IR2:
    JNB P3.2, WAIT_RELEASE_IR2 ; Doi den khi cam bien khong bi che (P3.2 = 1)
